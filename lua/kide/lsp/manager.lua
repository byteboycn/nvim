...
local function resolve_config(server_name, ...)
  local defaults = {
    on_attach = require("kide.lsp").common_on_attach,
    on_init = require("kide.lsp").common_on_init,
    on_exit = require("kide.lsp").common_on_exit,
    capabilities = require("kide.lsp").common_capabilities(),
  }

  local has_custom_provider, custom_config = pcall(require, "kide.lsp.providers." .. server_name)
...
function M.setup(server_name, user_config)
  ...
  if nvim_lsp_utils.is_client_active(server_name) or client_is_configured(server_name) then
    return
  end
